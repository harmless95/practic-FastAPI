...
async def get_user_by_id(
    author_id: int, session: AsyncSession = Depends(db_helper.scoped_session_depends)
):
...
async def new_author(
    data: NewAuthor, session: AsyncSession = Depends(db_helper.scoped_session_depends)
):
